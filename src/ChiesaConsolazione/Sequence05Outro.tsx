  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily: 'Lato, sans-serif', fontSize: 12, color: COLORS.oroAntico, letterSpacing: '0.25em', textTransform: 'uppercase', marginBottom: 20, opacity: 0.80 }}>
      ...
      <div style={{ position: 'absolute', bottom: 52, left: 120, display: 'flex', alignItems: 'center', gap: 16, opacity: lc * lFade, transform: `translateY(${interpolate(lc, [0, 1], [16, 0])}px)` }}>
        ...
        <div>
          ...
          <div style={{ fontFamily: 'Lato, sans-serif', fontWeight: 300, fontSize: 11, letterSpacing: '0.06em', color: COLORS.oroAntico, opacity: 0.90 }}>Alta Irpinia · Campania</div>
        </div>
      </div>
