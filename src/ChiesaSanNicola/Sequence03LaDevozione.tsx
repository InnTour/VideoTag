    ...
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {counterOp > 0 && (
        <div style={{ position: 'absolute', right: 140, top: 140, opacity: counterOp, textAlign: 'center' }}>
          <div style={{ fontFamily: 'Playfair Display, serif', fontSize: 100, fontWeight: 700, color: COLORS.oroSacro, lineHeight: 1, textShadow: `0 0 40px rgba(212,168,67,0.40)` }}>{counterVal}</div>
          <div style={{ fontFamily: 'Lato, sans-serif', fontSize: 16, letterSpacing: '0.18em', textTransform: 'uppercase', color: COLORS.avorioCarta, marginTop: 8 }}>Congrega fondata</div>
        </div>
      )}
      ...
      <div style={{ position: 'absolute', left: 72, top: 120, opacity: interpolate(card1, [0, 1], [0, 1]), transform: `translateY(${interpolate(card1, [0, 1], [30, 0])}px)`, background: 'rgba(8,8,12,0.80)', backdropFilter: 'blur(18px)', borderRadius: 8, border: `1px solid rgba(212,168,67,0.28)`, padding: '22px 30px', maxWidth: 520 }}>
        <div style={{ fontFamily: 'Lato, sans-serif', fontWeight: 700, fontSize: 16, letterSpacing: '0.20em', textTransform: 'uppercase', color: COLORS.oroSacro, marginBottom: 10 }}>1746 · Padri Liguorini</div>
      ...
      <div style={{ position: 'absolute', left: 72, bottom: 240, opacity: interpolate(card2, [0, 1], [0, 1]), transform: `translateY(${interpolate(card2, [0, 1], [30, 0])}px)`, background: 'rgba(8,8,12,0.76)', backdropFilter: 'blur(18px)', borderRadius: 8, border: `1px solid rgba(155,42,42,0.28)`, padding: '20px 28px', maxWidth: 500 }}>
        <div style={{ fontFamily: 'Lato, sans-serif', fontWeight: 700, fontSize: 16, letterSpacing: '0.18em', textTransform: 'uppercase', color: COLORS.rossoMarmo, marginBottom: 8 }}>L'altare della Cicogna</div>
