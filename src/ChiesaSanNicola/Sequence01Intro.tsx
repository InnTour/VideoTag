...
export const Sequence01Intro: React.FC = () => {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      {/* Ghost anno 1456 */}
      <div style={{ position: 'absolute', top: '50%', right: 40, transform: 'translateY(-50%)', fontFamily: 'Playfair Display, serif', fontSize: 220, fontWeight: 700, color: COLORS.oroSacro, opacity: 0.06, pointerEvents: 'none', writingMode: 'vertical-rl' }}>1456</div>
