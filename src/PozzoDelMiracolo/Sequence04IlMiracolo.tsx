...
export const Sequence04IlMiracolo: React.FC = () => {
  ...
  const card3 = spring({ frame: Math.max(0, frame - 210), fps, config: { damping: 160 } });
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      <div style={{
        ...
        transform: `translateY(${interpolate(card3, [0, 1], [25, 0])}px)`,
        ...
        <div style={{
          fontFamily: 'Lato, sans-serif', fontWeight: 300, fontSize: 21,
          color: COLORS.biancoCalce, lineHeight: 1.55,
        }}>
