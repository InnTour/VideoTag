...
export const Sequence03LaChiave: React.FC = () => {
  ...
  const card2 = spring({ frame: Math.max(0, frame - 90), fps, config: { damping: 160 } });
  const quoteEntrance = spring({ frame: Math.max(0, frame - 200), fps, config: { damping: 180 } });
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      <div style={{
        ...
        transform: `translateY(${interpolate(quoteEntrance, [0, 1], [20, 0])}px)`,
      }}>
        <div style={{
