...
// ─────────────────────────────────────────────────────────────
// Seq05 — L'Anima · Outro (~14.7s · 441 frame)
...
export const Sequence05Outro: React.FC = () => {
  ...
  const taglineFade = interpolate(frame, [durationInFrames - 100, durationInFrames - 62], [1, 0], {
    extrapolateLeft: 'clamp', extrapolateRight: 'clamp',
  });

  // Linee decorative
  const lineW = interpolate(frame, [5, 52], [0, 280], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' });
  ...
  const logoFade = interpolate(frame, [durationInFrames - 92, durationInFrames - 54], [1, 0], {
    extrapolateLeft: 'clamp', extrapolateRight: 'clamp',
  });
  ...
  // Iris outro
  const irisP = interpolate(frame, [durationInFrames - 84, durationInFrames - 8], [0, 1], {
    extrapolateLeft: 'clamp', extrapolateRight: 'clamp',
  });
